...
const Contact = () => {
  ...
  return (
    <footer id="contact">
      <img src="/images/footer-right-leaf.png" alt="right-leaf-img" id="f-right-leaf" />
      <img src="/images/footer-left-leaf.png" alt="left-leaf-img" id="f-left-leaf" />
